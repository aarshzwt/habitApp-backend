...
const { getLogById, getLogsOfUser, getAllLogsOfChallenge, getLogs, updateChallengeLog } = require("../controllers/challengeLogs");
...
router.post("/challenge/:challenge_id", authorizeRole(['user', 'admin']), updateChallengeLog); //update user's log of given challenge_id
